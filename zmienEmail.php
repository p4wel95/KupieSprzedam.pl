<?php
    ...
    if ((isset($_POST['haslo'])) && (isset($_POST['email'])))
    {
        ...
        else
        {
            ...
            {
                $query = "select haslo,email from uzytkownicy where id=".$_SESSION['id'];
                ...
                if (password_verify($haslo, $wiersz['haslo']))
                {
                    ...
                    {
                        $query = "update uzytkownicy set email='".$email."' where id=".$_SESSION['id'];
                ...
                {
                    $_SESSION['e_zmianaEmail']="Bledne haslo";
                }
