<?php
    ...
    if (isset($_GET['dodaj']))
    {
        ...
        $id_wlasciciela = $_SESSION['id_wlasciciela'];
        ...
        $query = "INSERT INTO ogloszenia VALUES ('','".$tytul."','".$opis."','".$cena."','".$id_wlasciciela."',"
                            . "'".$kontakt."', '".$kategoria."', '".$podkategoria."', '".$wojewodztwo."', '".$miejscowosc."',"
                            . "'".$img[0]."','".$img[1]."','".$img[2]."','".$img[3]."','".$img[4]."','".$img[5]."',NOW())";
        
        $polaczenie->query($query);
        
        $query = "delete from ogloszenia where id=".$_SESSION['id_ogloszenia'];
        $polaczenie->query($query);
        
        $_SESSION['zmieniono_ogloszenie']=true;
    ...
    if (isset($_POST['tytul']))
	{
            ...
            $id_wlasciciela = $_POST['id_wlasciciela'];
            $img[0] = "";
            $img[1] = "";
            $img[2] = "";
            $img[3] = "";
                   ...
                   if ($_FILES['file']['type'][$i] == "image/jpeg" || $_FILES['file']['type'][$i] == "image/png")
                    {
                       ...
                       move_uploaded_file($_FILES['file']['tmp_name'][$i], 'img/'.$img[$i]);
            ...
            $_SESSION['id_wlasciciela'] = $id_wlasciciela;
...
<body>
	<div class="container">
            ...
            <div class="blok">
                <a href="edytuj.php" style="color:yellow">Popraw ogloszenie</a>
